...
std::vector<std::string> SMUGGERS = { "alphaz1", "bombushka", "cyclone", "havok", "howard", "hunter", "microlight", "mogul", "molotok", "nokota", "pyro", "rapidgt3", "retinue", "rogue", "seabreeze", "starling", "tula", "vigilante", "visione" };
