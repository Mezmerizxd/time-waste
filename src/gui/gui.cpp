...
char PlateText[9]     = { 0 };
float ColWheelR, ColWheelG, ColWheelB;
float ColWheel[3] = { ColWheelR, ColWheelG, ColWheelB };
...
void Gui::dx_init()
{
	...
	= ImVec4(defaultColor.x, defaultColor.y, defaultColor.z, 1.00f);
	...
	= ImVec4(defaultColor.x, defaultColor.y, defaultColor.z, 0.54f);
	...
	= ImVec4(defaultColor.x, defaultColor.y, defaultColor.z, 0.31f);
	colors[ImGuiCol_HeaderHovered]
	= ImVec4(defaultColor.x, defaultColor.y, defaultColor.z, 0.37f);
	colors[ImGuiCol_HeaderActive]
	= ImVec4(defaultColor.x, defaultColor.y, defaultColor.z, 0.51f);
	...
	= ImVec4(defaultColor.x, defaultColor.y, defaultColor.z, 0.86f);
