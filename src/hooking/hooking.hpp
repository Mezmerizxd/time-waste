#pragma once
#include "../common.hpp"
#include "../detour_hook/detour_hook.hpp"
#include "../gta/fwddec.hpp"
#include "../script_hook/script_hook.hpp"
...
struct hooks
{
	...
	static HRESULT swapchain_present(
	IDXGISwapChain* this_, UINT sync_interval, UINT flags);
	static HRESULT swapchain_resizebuffers(IDXGISwapChain* this_,
	UINT buffer_count, UINT width, UINT height, DXGI_FORMAT new_format,
	...
	static void main_persistent_dtor(
	CGameScriptHandler* this_, bool free_memory);
